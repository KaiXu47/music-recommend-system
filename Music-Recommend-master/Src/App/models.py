...
from Src.App.settings import SCRAPY_PATH, MUSIC_PATH, RATE_PATH, CHROMEDRIVER_PATH, SCORE, RECOMMEND_PATH, ALGO_OPT, \
    READER_OPT, RECOMMEND_NUM
...
class Rate():
    ...
    def dump2file(uid, sid, score):
        with open(RATE_PATH, 'a') as f:
            f.write("{},{},{},{}\n".format(uid, sid, score + 10, time.time()))
            f.flush()
...
class MusicSearch(object):
    ...
    def get_music_by_text(self, text):
        ...
        ret = ConnectMysql.get_all_songs(self.conn)
...
class MusicManager():
    ...
    def get_recommend(self, uid, offset=0, limit=50, topk=RECOMMEND_NUM):
